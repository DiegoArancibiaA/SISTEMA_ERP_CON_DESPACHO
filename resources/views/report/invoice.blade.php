...
@section('title','AlphaERP | Invoice-Report')
				...
				<div class="table-responsive">
					<table class="table table-bordered">
						<thead>
							...
							<tr style="border: none !important;">
								<td colspan="8" style="border: none !important;"><p style="text-align: center;font-weight: bold;">Reporte de Factura desde {{ date('j M Y',strtotime($start_date)) }} a {{ date('j M Y',strtotime($end_date)) }}</p></td>

							</tr>
							<tr>
								<th>N° de Factura</th> {{-- Traducción --}}
								<th>Fecha de Factura</th> {{-- Traducción --}}
								<th>Cliente</th> {{-- Traducción --}}
								<th>Vendedor</th> {{-- Traducción --}}
								<th>Detalles</th> {{-- Traducción --}}
								<th>Monto Total</th> {{-- Traducción (más común en Chile) --}}
								<th>Monto Pagado</th> {{-- Traducción (más común en Chile) --}}
								<th>Deuda</th> {{-- Traducción (más común en Chile) --}}
							</tr>
						</thead>
