...
CREATE DATABASE IF NOT EXISTS `db_AlphaERP` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `db_AlphaERP`;

-- Volcando estructura para tabla db_AlphaERP.biye
...
-- Volcando datos para la tabla db_AlphaERP.biye: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla db_AlphaERP.categories: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla db_AlphaERP.customers: ~19 rows (aproximadamente)
REPLACE INTO `customers` (`id`, `customer_name`, `email`, `phone`, `address`, `latitude`, `longitude`, `status`, `created_at`, `updated_at`) VALUES
	(37, 'Juan Pérez', 'juan.perez@example.com', '555-1234', 'Calle 1, Colonia Centro, Ciudad de México', 19.4368197, -99.1463904, 1, '2023-04-17 02:08:05', '2025-08-02 05:07:00'),
	(38, 'María Rodríguez', 'maria.rodriguez@example.com', '555-5678', 'Calle 2, Colonia Condesa, Ciudad de México', 19.4162603, -99.1776382, 1, '2023-04-17 02:08:05', '2025-08-02 05:07:04'),
	(39, 'Pedro García', 'pedro.garcia@example.com', '555-9876', 'Calle 3, Colonia Roma, Ciudad de México', 19.4183227, -99.1625655, 1, '2023-04-17 02:08:05', '2025-08-02 05:07:08'),
	(40, 'Ana Hernández', 'ana.hernandez@example.com', '5552468', 'Calle 4, Colonia Narvarte, Ciudad de México', 19.3877170, -99.1637481, 1, '2023-04-17 02:08:05', '2025-08-02 05:07:11'),
	(41, 'Jorge Martínez', 'jorge.martinez@example.com', '555-3691', 'Calle 5, Colonia Santa Fe, Ciudad de México', 19.3767802, -99.2329112, 1, '2023-04-17 02:08:05', '2025-08-02 05:07:14'),
	(42, 'Laura González', 'laura.gonzalez@example.com', '555-5555', 'Calle 6, Colonia Polanco, Ciudad de México', 19.4515099, -99.2004128, 1, '2023-04-17 02:08:05', '2025-08-02 05:07:19'),
	(43, 'Miguel Álvarez', 'miguel.alvarez@example.com', '555-7777', 'Calle 7, Colonia Juárez, Ciudad de México', 19.4279483, -99.1588279, 1, '2023-04-17 02:08:05', '2025-08-02 05:07:24'),
	(44, 'Carmen Flores', 'carmen.flores@example.com', '555-1212', 'Calle 8, Colonia Coyoacán, Ciudad de México', 19.3176774, -99.1327633, 1, '2023-04-17 02:08:05', '2025-08-02 05:07:30'),
	(45, 'José García', 'jose.garcia@example.com', '555-7777', 'Calle 9, Colonia Del Valle, Ciudad de México', 19.3942366, -99.1670335, 1, '2023-04-17 02:08:05', '2025-08-02 05:07:34'),
	(46, 'Fernanda González', 'fernanda.gonzalez@example.com', '555-2345', 'Calle 10, Colonia San Ángel, Ciudad de México', 19.3446999, -99.1879459, 1, '2023-04-17 02:08:05', '2025-08-02 05:07:38'),
	(47, 'Diego Torres', 'diego.torres@example.com', '555-4567', 'Calle 11, Colonia Santa María la Ribera, Ciudad de México', 19.4483603, -99.1617759, 1, '2023-04-17 02:08:05', '2025-08-02 05:07:41'),
	(48, 'Carla Hernández', 'carla.hernandez@example.com', '555-1111', 'Calle 12, Colonia Tabacalera, Ciudad de México', 19.4337409, -99.1573522, 1, '2023-04-17 02:08:05', '2025-08-02 05:07:44'),
	(49, 'Raúl Díaz', 'raul.diaz@example.com', '555-2222', 'Calle 13, Colonia Doctores, Ciudad de México', 19.4169648, -99.1489862, 1, '2023-04-17 02:08:05', '2025-08-02 05:07:47'),
	(50, 'Sofía García', 'sofia.garcia@example.com', '555-3333', 'Calle 14, Colonia Lindavista, Ciudad de México', 19.4925823, -99.1292587, 1, '2023-04-17 02:08:05', '2025-08-02 05:07:50'),
	(51, 'Héctor Jiménez', 'hector.jimenez@example.com', '555-4444', 'Calle 15, Colonia Vallejo, Ciudad de México', 19.5201780, -99.1577679, 1, '2023-04-17 02:08:05', '2025-08-02 05:07:53'),
	(52, 'Diana Martínez', 'diana.martinez@example.com', '555-5555', 'Calle 16, Colonia Industrial, Ciudad de México', 19.4749623, -99.1257781, 1, '2023-04-17 02:08:05', '2025-08-02 05:07:56'),
	(53, 'Juan Arancibia A', 'arancibia.dev@gmail.com', '936414303', 'Calle Prat 789, Valparaíso, Región de Valparaíso, Chile', -33.0398166, -71.6275765, 1, '2025-08-02 05:58:39', '2025-08-02 06:25:39'),
	(54, 'Pia Guerra', 'by.agatha@gmail.com', '56936414303', 'Isabel Riquelme 866, Antofagasta, Región de Antofagasta, Chile', -23.6113369, -70.3805412, 1, '2025-08-02 06:46:22', '2025-08-02 07:38:16'),
	(55, 'Tatiana Alvarado', 'carmonabernaldiego@gmail.com', '932456789', 'Achao 5998, Antofagasta, Región de Antofagasta, Chile', -23.6184080, -70.3792908, 1, '2025-08-02 07:42:42', '2025-08-02 08:33:04'),
	(56, 'Karime Guerra', 'diegho.hulk@gmail.com', '999685060', 'Juan Pablo II 634, Antofagasta, Región de Antofagasta, Chile', -23.5779362, -70.3874410, 1, '2025-08-02 08:35:37', '2025-08-02 08:36:02');
...
-- Volcando datos para la tabla db_AlphaERP.menus: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla db_AlphaERP.migrations: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla db_AlphaERP.payments: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla db_AlphaERP.permissions: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla db_AlphaERP.products: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla db_AlphaERP.roles: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla db_AlphaERP.stocks: ~0 rows (aproximadamente)
REPLACE INTO `stocks` (`id`, `product_code`, `product_id`, `category_id`, `vendor_id`, `user_id`, `chalan_no`, `buying_price`, `selling_price`, `discount`, `stock_quantity`, `current_quantity`, `note`, `status`, `created_at`, `updated_at`) VALUES
	(55, '1681681567', 30, 34, 81, 12, '2023-04-16', 9.8, 12.5, 0, 100, 67, NULL, 1, '2023-04-16 22:46:07', '2023-04-17 05:33:31'),
	(56, '1681705778', 67, 37, 81, 12, '2023-04-16', 189.99, 249.99, 0, 48, 48, NULL, 1, '2023-04-17 05:29:38', '2023-04-17 05:29:38');
...
-- Volcando datos para la tabla db_AlphaERP.users: ~0 rows (aproximadamente)
REPLACE INTO `users` (`id`, `name`, `email`, `password`, `branch_id`, `role_id`, `remember_token`, `created_at`, `updated_at`) VALUES
	(12, 'Diego Carmona Bernal', 'carmonabernaldiego@gmail.com', '$2y$10$W/nqTuN0X.JaGtGBkpw01OTSL0I3aShYL9QusP8Q5kIZ2AviqQHKC', 1, 2, 'RXwbEFrJ1dxS0Z3zaf154NCqYBvA20mHSB4J3l0Z3JStQoEJBuPjiC8MowOf', '2020-07-31 17:27:25', '2023-04-17 05:20:18');
...
-- Volcando datos para la tabla db_AlphaERP.vendors: ~0 rows (aproximadamente)
